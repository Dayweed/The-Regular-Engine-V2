...
namespace TRE
{
	...
	class ECSSystem
	{
		public:
			...
			virtual void LateUpdate() {}        // This is called AFTER both Update() and GameUpdate()
			virtual void BeforeReset() {}       // This is called before the scene gets reset in the previous loop
			virtual void AfterReset() {}        // This is called after the scene gets reset in the previous loop
