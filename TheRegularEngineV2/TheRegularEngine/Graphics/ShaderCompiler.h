...
namespace TRE
{
	...
	class ShaderCompiler
	{
		public:
			...
			static std::shared_ptr<Shader> CompileShader(const std::filesystem::path& ShaderPath, bool EnableOptimization = true);
		...
		private:
			...
			bool CompileGLSLToBinary(std::vector<uint32_t>& OutputBinary, const std::string& SourceCode);
